...
#@ ensures forall j in range(len(reqs)) :: result[1][j] == result[0][j] or result[1][j] % page_size == 0
...
def page_aligned_decode_alloc_lens(
    ...
    *,
    ...
    for i, r in enumerate(reqs):
        ...
        #@ invariant forall j in range(i) :: nxt_kv_lens[j] == cur_kv_lens[j] or nxt_kv_lens[j] % page_size == 0
