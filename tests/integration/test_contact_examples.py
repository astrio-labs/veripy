...
These annotated HumanEval/MBPP examples exercise the comment grammar and
strict type gate. Some intentionally exceed the proof backend fragment.
"""
...
CONTACT = Path(__file__).resolve().parents[2] / "examples" / "contact"
