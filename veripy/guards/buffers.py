...
import hashlib
import inspect
from .runtime import PreconditionError,PostconditionError,guard_value
...
def emit_buffer_guarded(source,specs,src_name,*,check_ensures=False,proof_lemmas=frozenset()):
    from ..backends.dafny.buffers import encode_buffers
    from .emitter import _reject_reserved_names
