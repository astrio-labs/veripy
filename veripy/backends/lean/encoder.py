...
from veripy.frontend.parse import FunctionSpec, ModuleSpecs
...
from veripy.backends.lean.prelude import PRELUDE, PRELUDE_VERSION  # noqa: F401  (version re-exported)
