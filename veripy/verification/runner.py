...
substance of `veripy verify --json`: per-failure records carrying the
...
from veripy.backends.base import ProofBackend, get_backend
...
from veripy.verification.failures import TAXONOMY_VERSION
...
def _record(kind: str, *, message: str, rule: str | None = None,
            function: str | None = None, region: str | None = "source",
