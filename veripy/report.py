...
ASSUMPTIONS: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "status": "assumed",
        "residual": "`veripy guard` emits the boundary; nothing prevents a "
    ...
    },
    {
        ...
        "residual": "Continuously cross-checked by the differential harness "
                    "(veripy difftest) on every corpus function.",
    },
    {
        "id": "A5",
...
class FunctionReport:
    ...
    guard_mode: str = "guarded module available via `veripy guard`; trusted callers import the original"
...
def build_report(functions: list[FunctionReport], sidecar_lemmas: dict[str, list[str]],
    ...
    return {
        "schema": "veripy-verification-report/1",
